...
seo:
  ...
  description: Learn how validation works in Goodie Forms. Use StandardSchema-compatible libraries like Zod, Valibot, or ArkType, or implement fully custom validation strategies with complete type safety.
---
...
- A [StandardSchema](https://standardschema.dev/) based approach (recommended for most cases)
...
**Goodie Forms** supports [StandardSchema](https://standardschema.dev/) compatible **validators**,
