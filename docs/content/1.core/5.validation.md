---
title: Validation
description: Validate input data before submitting the form.
navigation:
  icon: hugeicons:file-validation
seo:
  title: Validation in Goodie Forms — Schema & Custom Strategies
  description: Learn how validation works in Goodie Forms. Use Standard Schema-compatible libraries like Zod, Valibot, or ArkType, or implement fully custom validation strategies with complete type safety.
---
...
**Schema validation** keeps your form **predictable**, **maintainable**, and **aligned** with your **domain model** — _without coupling Goodie Forms to any specific validation library._
...
:::card
---
title: Zod GitHub Repository
icon: simple-icons:github
to: https://github.com/colinhacks/zod
---
...
:::card
---
title: Volibot Official Docs
icon: goodie:brand-valibot
to: https://valibot.dev/
---
Check out the [Volibot documentation](https://valibot.dev/) for more details on how to define schemas and validation rules.
:::
:::card
---
title: Volibot GitHub Repository
icon: simple-icons:github
to: https://github.com/open-circle/valibot
---
...
:::card
---
title: ArkType Official Docs
icon: goodie:brand-arktype
to: https://arktype.dev/
---
Check out the [ArkType documentation](https://arktype.dev/) for more details on how to define schemas and validation rules.
:::
:::card
---
title: ArkType GitHub Repository
icon: simple-icons:github
to: https://github.com/arktypeio/arktype
---
...
::card
---
title: Standard Schema Libraries
icon: goodie:brand-standardschema
to: https://standardschema.dev/schema#what-schema-libraries-implement-the-spec
---
