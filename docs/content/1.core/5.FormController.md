...
It acts as a headless, type-safe form state manager responsible for handling data, validation, field registration, submission flow, and lifecycle events — without imposing any UI constraints.
