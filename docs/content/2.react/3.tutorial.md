...
::doc-ref-section
We can enforce strong validation using `zod` (or [any other StandardSchema-compatible library](https://standardschema.dev/schema#what-schema-libraries-implement-the-spec)).
